  ...
  return (
    <section>
      <div className="w-app-content-boundary mx-auto page-padded-section grid grid-cols-1 xs:grid-cols-2 gap-y-4">
        ...
        <div className="flex justify-end max-xs:order-3">
          <Link
            to={"/products"}
            className="inline-flex items-center gap-2 uppercase focus-within:bg-foreground focus-within:text-background px-2 rounded-md">
